package body Generics is
   ...
   package body Services is
      ...
      function Local_Blank return String;  -- will FLAG in instances
      ...
      function Local_Image (X : Integer) return String is  -- will FLAG in instances
      begin
         return Local_Blank;
      end;
      ...
      function Local_Blank return String is -- NO FLAG
      begin
         return " ";
      end;
   end;
