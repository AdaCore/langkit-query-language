package Address_Attribute_For_Non_Volatile_Objects is
   ...
   X : Integer with Address => Var1'Address;   --  NO FLAG
   Y : Integer with Address => Var2'Address;   --  FLAG

   --  Address attribute specification clause:
   Var_Non_Volatile : Integer;
   for Var_Non_Volatile'Address use Var1'Address;     --  NO FLAG

   --  Constant object:

   Const : constant Integer := 123;
   Var   : Integer with Address => Const'Address;     --  NO FLAG
   ...
   Var_3 : Integer with Address => Var_2.all'Address; --  NO FLAG
   ...
   V_Int_1 : Integer with Address => Var_Arr_5'Address;  --  NO FLAG
