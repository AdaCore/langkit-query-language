procedure Float_Equality_Checks is
   ...
   B2_A : constant Boolean := A_Coeff = B_Coeff;              -- NO FLAG
   B2_B : constant Boolean := A_Coeff /= B_Coeff;             -- NO FLAG
   ...
   B5_A : constant Boolean := A_SF = B_SF;                    -- NO FLAG
   B5_B : constant Boolean := A_SF /= B_SF;                   -- NO FLAG
   ...
   B8_A : constant Boolean := A_Volt = B_Volt;                -- NO FLAG
   B8_B : constant Boolean := A_Volt /= B_Volt;               -- NO FLAG
   Result : Boolean;
...
begin
   Result := Renamed_Eq (A_Float, B_Float);  -- NO FLAG
   Result := Renamed_Not_Eq (A_SF, B_SF);    -- NO FLAG
