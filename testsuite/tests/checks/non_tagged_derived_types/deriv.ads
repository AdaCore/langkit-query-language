package Deriv is
   ...
   type T_Rec_D is new T_Rec with record         --  NO FLAG
      B : Boolean;
   end record;
   ...
   type T_Rec_DP is new T_Rec with private;      --  NO FLAG
...
private
   ...
   type T_Priv_2 is new T_Rec with record        --  NO FLAG
      I : T_Priv_1;
   end record;

   type T_Rec_DP is new T_Rec with null record;  --  NO FLAG
