...
public final class NextSiblingsSelector implements BuiltInSelector {
    ...
    public LKQLSelector getValue() {
        return new BuiltInSelectorValue(NAME, "Yields the siblings following the given node in the tree\n", this.arms);
    }
    ...
    private static SelectorArm[] createArms() {
        ...
        DotAccess propertyAccess =
                DotAccessNodeGen.create(null, new Identifier(null, "next_sibling"), new ReadBuiltInThis());
