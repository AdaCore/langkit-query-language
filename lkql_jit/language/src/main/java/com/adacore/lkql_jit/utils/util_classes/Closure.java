...
public final class Closure {
    ...
    private final MaterializedFrame content;
    ...
    public void instantiate(MaterializedFrame frame) {
        for(int i = 0 ; i < this.content.getFrameDescriptor().getNumberOfSlots() ; i++) {
            if(this.content.getObject(i) != null) {
                frame.setObject(i, this.content.getObject(i));
            }
        }
    }
