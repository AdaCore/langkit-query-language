...
public final class Closure {
    ...
    public static Closure create(
        ...
        for (Map.Entry<Integer, Integer> closingLocal : closureDescriptor.getClosingLocals().entrySet()) {
            content[closingLocal.getKey()] = (Cell) frame.getObject(closingLocal.getValue());
        }

        // Put all needed parameters in the closure
        for (Map.Entry<Integer, Integer> closingParameter : closureDescriptor.getClosingParameters().entrySet()) {
        ...
        for (Map.Entry<Integer, Integer> closingClosure : closureDescriptor.getClosingClosures().entrySet()) {
