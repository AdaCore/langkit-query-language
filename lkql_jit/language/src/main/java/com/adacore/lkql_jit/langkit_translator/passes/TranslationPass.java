...
public final class TranslationPass implements Liblkqllang.BasicVisitor<LKQLNode> {
    ...
    public LKQLNode visit(Liblkqllang.DeclAnnotation declAnnotation) {
        ...
        return new DeclarationAnnotation(loc(declAnnotation), name, arguments);
    }
    ...
    public LKQLNode visit(Liblkqllang.ParameterDecl parameterDecl) {
        ...
        // Get the parameter slot
        final int slot = this.scriptFrames.getParameter(name);
    ...
    public LKQLNode visit(Liblkqllang.Query query) {
        ...
        // Get the query kind
        final Query.QueryKind queryKind;
    ...
    public LKQLNode visit(Liblkqllang.FunDecl funDecl) {
        ...
        final DeclarationAnnotation annotation = annotationBase.isNone() ?
            null :
            (DeclarationAnnotation) annotationBase.accept(this);
    ...
    public LKQLNode visit(Liblkqllang.SelectorDecl selectorDecl) {
        ...
        this.scriptFrames.declareBinding("this");
        this.scriptFrames.declareBinding("depth");
        final int thisSlot = this.scriptFrames.getBinding("this");
        final int depthSlot = this.scriptFrames.getBinding("depth");
