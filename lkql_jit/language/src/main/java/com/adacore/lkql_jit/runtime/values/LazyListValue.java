...
/**
 * This class represents a lazy list in the LKQL language, this is the result of a list
 * comprehension.
 *
...
public final class LazyListValue extends LazyCollection {
    ...
    public LazyListValue(ListComprehensionRootNode rootNode, Closure closure, Object[][] argsList) {
    ...
    protected void initCache(int index) {
        while (this.lazyPointer < this.argsList.length
                && (this.cache.size() - 1 < index || index == -1)) {
            Object value =
                    this.dispatcher.executeDispatch(
                            this.rootNode,
                            ArrayUtils.concat(
                                    new Object[] {this.closure.getContent()},
                                    this.argsList[this.lazyPointer++]));
            if (value != null) {
