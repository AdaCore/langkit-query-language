...
public abstract class RewritingNodeConverter extends Node {
     ...
     */
    public abstract LangkitSupport.RewritingNode execute(
        Object value,
    ...
    @Specialization
    protected LangkitSupport.RewritingNode onNull(
        ...
        /*
         * TODO: Genericize LKQL issue or Java issue. Returning a "null" rewriting node requires to
    ...
    protected LangkitSupport.RewritingNode onNodeInterface(
    ...
    @Specialization
    protected LangkitSupport.RewritingNode onRewritingNode(
        LangkitSupport.RewritingNode node,
        boolean ensureUntied,
        @SuppressWarnings("unused") Node usageLocation
    ) {
    ...
    @Fallback
    protected LangkitSupport.RewritingNode notNode(
        Object other,
        boolean ensureUntied,
        Node usageLocation
    ) {
