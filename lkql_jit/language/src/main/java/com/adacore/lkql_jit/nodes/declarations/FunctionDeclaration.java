...
public final class FunctionDeclaration extends Declaration {
     ...
     */
    private final Constants.CheckerMode checkerMode;
    ...
    public FunctionDeclaration(
        ...
        final DeclarationAnnotation annotation,
        final String name,
        final int slot,
        ...
        if (annotation != null) {
            ...
            if (annotationName.equals(Constants.ANNOTATION_NODE_CHECK)) {
                this.checkerMode = Constants.CheckerMode.NODE;
            } else if (annotationName.equals(Constants.ANNOTATION_UNIT_CHECK)) {
                this.checkerMode = Constants.CheckerMode.UNIT;
            } else {
                this.checkerMode = Constants.CheckerMode.OFF;
            }
        } else {
    ...
    public Object executeGeneric(VirtualFrame frame) {
        ...
        if (this.checkerMode != Constants.CheckerMode.OFF) {
