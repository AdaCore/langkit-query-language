...
public abstract class FieldLink extends ChainedPatternLink {
     ...
     */
    protected FieldLink(SourceLocation location, BasePattern pattern, String fieldName) {
    ...
    protected Libadalang.AdaNode[] fieldUnached(VirtualFrame frame, Libadalang.AdaNode node) {
