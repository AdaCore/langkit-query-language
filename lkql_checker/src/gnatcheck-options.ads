...
package Gnatcheck.Options is
   ...
   LKQL_Rule_File_Processed : Boolean := False;
   --  Whether the (potential) LKQL rule file has already been processed.
   ...
   package Arg is
      ...
      package Rules is new Parse_Option_List
        (Parser      => Parser,
         ...
         Arg_Type    => Unbounded_String,
         Allow_Empty => True,
         Help        => "enable the given rules for the GNATcheck run");
