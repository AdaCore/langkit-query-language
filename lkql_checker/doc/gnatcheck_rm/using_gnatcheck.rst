...
``-U``
  If a project file is specified and no argument source is provided by the mean
  of the ``-files`` option, process all units of the closure of the argument
  project. Otherwise, this option has no effect.
