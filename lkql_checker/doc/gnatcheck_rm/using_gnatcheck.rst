...
.. note::
  ...
  Exemption mechanism is available for GNATkp as well but you have to change
  pragmas and comments a bit to avoid conflict with GNATcheck exemptions. Thus,
  pragmas annotations' first argument must be 'gnatkp' instead of 'gnatcheck',
  example:
