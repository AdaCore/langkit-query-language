...
.. attention::
   This is forbidden to provide the same restriction name in multiple instances
...
.. attention::
   This is forbidden to provide the same parameter in multiple instance of the
...
.. attention::
   This is forbidden to provide the same parameter in multiple instances of the
