...
.. admonition:: LKQL STATUS
    ...
    Missing LAL properties: need to extract stuff about controlling
    results/controlling parameters.
...
.. admonition:: LKQL STATUS
    ...
    Missing LAL properties: Need to extract the logic to check if a subprogram
    is a primitive of a tagged type from ``is_dispatching_call``
...
the result of subprogram import and export.
